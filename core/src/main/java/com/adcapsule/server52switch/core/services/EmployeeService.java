...
/**
    ...
    public List<String> findGroupMembersBySupervisorOid(String supervisorOid) {
        ...
        return memberOidList;
    }
    public List<String> findEmployeeOidListbyGroupId(String groupId){
        
        // Map the projections to a list of strings (dayoffType)
        return employeeRepository.findEmployeeOidListbyGroupId(groupId).stream()
